class SnapshotsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @snapshot.save
        format.html { redirect_to snapshot_url(@snapshot), notice: "Captura Creada Con Exito." }
  ...
  def update
    respond_to do |format|
      if @snapshot.update(snapshot_params)
        format.html { redirect_to snapshot_url(@snapshot), notice: "Captura actualizada con exito!" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to snapshots_url, notice: "Captura eliminada con Exito.." }
  ...
  private
    ...
    def snapshot_params
      params.require(:snapshot).permit(:title, :color, :image)
    end
end
